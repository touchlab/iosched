...
public class Config {
    ...
    public static final String PROD_CONFERENCE_DATA_MANIFEST_URL = "https://droidcon-server.herokuapp.com/dataTest/manifestWrapper/2000";
...
*/
    ...
    public static final String WIFI_PASSPHRASE = "touchlab";
